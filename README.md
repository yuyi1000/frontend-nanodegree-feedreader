...
![sample of feed reader testing](https://github.com/yuyi1000/frontend-nanodegree-feedreader/blob/master/imgs/sample.png | width=100 "sample of feed reader testing")


## How to run this project

Simply open "index.html" file in the browser and you should see 7 specs have been passed and 0 fails in the Jasmine framework.
